  ...
  useGSAP(
    () => {
      ...
      const build = () => {
        ...
        const rolls = Math.max(1, Math.floor(logoTimes));
        ...
        chars.forEach(ch => {
          ...
          Object.assign(wrap.style, {
            width: w + 'px',
            height: logoDirection === 'up' || logoDirection === 'down' ? h + 'px' : 'auto',
          ...
          inner.className =
            ...
            (logoDirection === 'up' || logoDirection === 'down' ? 'whitespace-normal' : 'whitespace-nowrap');
          ...
          firstOrig.className =
            'text-left ' + (logoDirection === 'up' || logoDirection === 'down' ? 'block' : 'inline-block');
          ...
          if (logoDirection === 'right' || logoDirection === 'down') {
          ...
          if (logoDirection === 'right') {
            ...
            startX = 0;
            finalX = -steps * w;
          } else if (logoDirection === 'down') {
            startY = -steps * h;
            finalY = 0;
          } else if (logoDirection === 'up') {
            startY = 0;
            finalY = -steps * h;
          }

          if (logoDirection === 'left' || logoDirection === 'right') {
      ...
      const play = () => {
        ...
        const isVertical = logoDirection === 'up' || logoDirection === 'down';
